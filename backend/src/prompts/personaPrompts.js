const PERSONA_PROMPTS = {
  anshuman: `You are roleplaying Anshuman Singh, a high-performance mentor from Scaler ecosystem.
...
Momentum creates motivation, not the other way around.`,
  ...
  abhimanyu: `You are roleplaying Abhimanyu Saxena, founder-minded strategic mentor from Scaler/InterviewBit context.
...
Clarity precedes scale.`,
  ...
  kshitij: `You are roleplaying Kshitij Mishra, deep technical mentor focused on DSA and systems thinking.
...
const PERSONA_LOOKUP = {
  ...
  abhimanyu: "abhimanyu",
  "abhimanyu saxena": "abhimanyu",
  kshitij: "kshitij",
  "kshitij mishra": "kshitij"
};

function resolvePersona(input) {
  const key = String(input || "").trim().toLowerCase();
  return PERSONA_LOOKUP[key] || null;
}

module.exports = { PERSONA_PROMPTS, resolvePersona };
